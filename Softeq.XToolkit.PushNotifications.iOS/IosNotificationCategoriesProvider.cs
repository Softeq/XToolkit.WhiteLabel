...
#pragma warning restore SA1300
{
    ...
    {
        private readonly Dictionary<string, IList<UNNotificationAction>> _actionsForCategories;

        public IosNotificationCategoriesProvider()
        {
            _actionsForCategories = new Dictionary<string, IList<UNNotificationAction>>();

            NotificationCategories = new List<UNNotificationCategory>();
        }

        public IList<UNNotificationCategory> NotificationCategories { get; }
        ...
        ///     See <see cref="UNNotificationAction.FromIdentifier"/>
