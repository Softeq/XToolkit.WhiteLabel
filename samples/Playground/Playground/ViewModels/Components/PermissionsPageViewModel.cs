...
namespace Playground.ViewModels.Components
{
    public class PermissionsPageViewModel : ViewModelBase
    {
        ...
        private bool _photosGranted;
        private bool _cameraGranted;
        private bool _storageGranted;
        private bool _locationGranted;
        private bool _locationInUseGranted;
        private bool _locationAlwaysGranted;
