...
{
    public abstract class BindableGroupTableViewSourceBase<TItem, TItemCell> : UITableViewSource
        where TItemCell : BindableTableViewCell<TItem>
    {
        ...
        protected BindableGroupTableViewSourceBase(UITableView tableView)
        {
    ...
    public abstract class BindableGroupTableViewSourceBase<TKey, TItem, TItemCell>
        : BindableGroupTableViewSourceBase<TItem, TItemCell>
        where TItemCell : BindableTableViewCell<TItem>
    {
        public BindableGroupTableViewSourceBase(
    ...
    public class BindableGroupTableViewSource<TItem, TItemCell>
        : BindableGroupTableViewSourceBase<TItem, TItemCell>
        where TItemCell : BindableTableViewCell<TItem>
    {
    ...
    public class BindableGroupTableViewSource<TKey, TItem, TGroupCell, TItemCell>
        : BindableGroupTableViewSourceBase<TKey, TItem, TItemCell>
        ...
        where TItemCell : BindableTableViewCell<TItem>
    {
        ...
        public override nfloat GetHeightForHeader(UITableView tableView, nint section)
        {
            ...
            return GetGeightForGroupCell(section);
        }
        ...
        private nfloat GetGeightForGroupCell(nint section)
        {
    ...
    public class BindableGroupTableViewSource<TKey, TItem, THeaderView, TFooterView, TItemCell>
        : BindableGroupTableViewSourceBase<TKey, TItem, TItemCell>
