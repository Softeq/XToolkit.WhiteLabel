...
{
    public interface IPushNotificationsService : IPushNotificationsCallbacks
    {
        ...
        /// </summary>
        /// <param name="showForegroundNotificationsInSystem">If true, notifications received in foreground will be shown in system as well as all other notifications.
        /// Note: On Android this parameter applies only if push notification contains 'notification' part, if it only contains 'data' part notifications will always be shown in system</param>
        ...
        // Receiving messages - inhereted from IPushNotificationsCallbacks
