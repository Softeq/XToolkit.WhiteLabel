...
namespace Softeq.XToolkit.Common.Tests.Helpers.TextRangeTests
{
    ...
    {
        public static TextRange CreateFisrtSymbolTextRange() => new TextRange(0, 1);

        public static string TestFullString => "Full string for test";
        ...
        public static IEnumerable<object[]> ValidTextRangeBuildStringData
        {
            get
            {
                ...
                yield return new object[] { TestFullString, "", 5, 6, "Full  for test" };
                ...
                yield return new object[] { "", "new", 0, 0, "new" };
