...
namespace Softeq.XToolkit.Common.Tests.Collections.ObservableKeyGroupsCollectionNew
{
    public class ObservableKeyGroupsCollectionNewTests
    {
        ...
        //{
        //    var groupCollection = new ObservableKeyGroupsCollection<string, string>(true);
        ...
        //{
        //    var groupCollection = new ObservableKeyGroupsCollection<string, string>(false);
        //    var listOfFiredActions = new List<NotifyKeyGroupCollectionChangedEventArgs<string, string>>();
        ...
        //{
        //    var groupCollection = new ObservableKeyGroupsCollection<string, string>(withoutEmptyGroups);
        //    var listOfFiredActions = new List<NotifyKeyGroupCollectionChangedEventArgs<string, string>>();
        ...
        //    ObservableKeyGroupsCollection<string, string> groupCollection)
        //{
        //    var listOfFiredActions = new List<NotifyKeyGroupCollectionChangedEventArgs<string, string>>();
        ...
        //public List<NotifyKeyGroupCollectionChangedEventArgs<string, string>> RemoveItemsTest(ObservableKeyGroupsCollection<string, string> groupCollection)
        //{
        //    var listOfFiredActions = new List<NotifyKeyGroupCollectionChangedEventArgs<string, string>>();
